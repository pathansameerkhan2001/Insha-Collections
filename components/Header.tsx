    ...
    <>
      <header className="w-full bg-[#FAF7F3] sticky top-0 z-40 transition-all duration-200 border-b border-[#EAE2D8]/60">
        <div className="max-w-[1440px] mx-auto px-4 sm:px-8 lg:px-12 h-20 sm:h-24 flex items-center justify-between relative">
          ...
          {/* Right: Interface Action Icons (Search, Wishlist, Cart) */}
          <div className="flex items-center gap-3.5 sm:gap-5 md:gap-6 text-[#231610]">
            {/* Search Icon */}
            <button
              type="button"
              onClick={() => {
              ...
              className="hover:text-[#B89366] transition-colors duration-200 p-1.5 focus:outline-none cursor-pointer"
            ...
            <button
              ...
              className="hover:text-[#B89366] transition-colors duration-200 p-1.5 relative focus:outline-none cursor-pointer"
              aria-label="Wishlist"
            >
              <Heart
