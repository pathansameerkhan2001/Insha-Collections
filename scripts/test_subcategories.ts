...
async function runTests() {
  ...
  const initialData = subcategoryStore.getAllWithCounts();
  ...
  const created = subcategoryStore.create("jewellery", testSubName);
  ...
  const renameResult = subcategoryStore.update("jewellery", testSubName, renamedName);
  ...
  const delResult = subcategoryStore.delete("jewellery", renamedName);
